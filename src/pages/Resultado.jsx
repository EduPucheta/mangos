...
let paymentsSum$Op2txt = 0;
  ...
  if (cantidaddecuotas != 0) {
    for (let i = 0; i < cantidaddecuotas; i += 1) {
      valoractualresult =
        (valordelacuota4 * (1+parseFloat( impuestoAlSello)) / Math.pow(1 + rate2, i + 1)) ; 
        console.log(1+rate2) 
  ...
  if (cantidaddecuotasOp2 != 0) {
    for (let i = 0; i < cantidaddecuotasOp2; i += 1) {
      valoractualresultop2 =
        (valordelacuota4Op2 * (1+parseFloat( impuestoAlSello)) / Math.pow(1 + rate2, i + 1)) ;
...
<div className="results__page">
  <div id="resultados">
    ...
    <div id="mensajederesultado3"></div>
            ...
            <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5036540983310099"
            ...
            <div className="Investments ResultCard">
                ...
                <ul className="nav nav-tabs Investments__Options" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                        <button className="nav-link active Investments__Option1" id="home-tab" data-bs-toggle="tab"
                    ...
                    <li className="nav-item" role="presentation">
                        <button className="nav-link Investments__Option2" id="profile-tab" data-bs-toggle="tab"
                ...
                <div className="tab-content Investments__tabcontent" id="myTabContent">
                    <div className="tab-pane fade show active Investments__content__option1" id="home-tab-pane"
                        role="tabpanel" aria-labelledby="home-tab" tabIndex="0"></div>
                    <div className="tab-pane fade Investments__content__option2" id="profile-tab-pane" role="tabpanel"
            ...
            <a href="https://cafecito.app/mangos_" className="cafecito" rel="noopener" target="_blank"><img srcSet="
            ...
            " src="https://cdn.cafecito.app/imgs/buttons/button_4.png" alt="Invitame un café en cafecito.app" /></a>
        </div>
    </>
  );
}
