...
export default function Resultado(
  ...
  console.log(valordelacuota4);
  console.log(cantidaddecuotasOp2);
  console.log(valordelacuota4Op2);
  console.log(anualInflation);
  console.log(impuestoAlSello);
  ...
  //// FUNCION PARA RESULTADOS
    ...
    console.log(firstResultMessage);
    // IMPUESTO AL SELLO
  ...
  return (
    <>
      <div className="results__page">
        <div id="resultados">
          <div id="mensajederesultado3">{firstResultMessage}</div>
        </div>
        <span>
          <div id="table">
            <table></table>
        ...
        <button className="startover">
          ...
          <Link to="/">Volver a comparar</Link>
        </button>
        <a
